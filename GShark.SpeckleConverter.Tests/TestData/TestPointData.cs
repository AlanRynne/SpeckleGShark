...
internal class TestPointData : IEnumerable<object[]>
{
  ...
  {
    yield return new object[] { new GSG.Point3(0, 0, 0), new OG.Point(0, 0, 0) };
    yield return new object[] { new GSG.Point3(1, 0, 0), new OG.Point(1, 0, 0) };
    yield return new object[] { new GSG.Point3(0, 1, 0), new OG.Point(0, 1, 0) };
